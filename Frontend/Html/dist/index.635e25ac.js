...
})({"kBnnB":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "32c2f00b635e25ac";
"use strict";
...
}); // import ProfileHeader from '../UiComponents/ProfileHeader';
 // import TabMenu from '../UiComponents/TabMenu';
 // import PersonalInfoSection from '../UiComponents/PersonalInfoSection';
 // import VehicleInfo from '../UiComponents/VehicleInfo';
 // import DocumentsDetails from '../UiComponents/DocumentsDetails';
 // import BankDetails from '../UiComponents/BankDetails';
 // import VerificationForm from '../UiComponents/VerificationForm';
 // document.addEventListener('DOMContentLoaded', function() {
 //     const profileHeader = new ProfileHeader(document.querySelector('.profile-header'));
 //     const tabMenu = new TabMenu(document.querySelector('.tab-menu'));
 //     const personalInfoSection = new PersonalInfoSection(document.querySelector('.personal-info-section'));
...
},{}]},["kBnnB","41jrU"], "41jrU", "parcelRequire94c2")

//# sourceMappingURL=index.635e25ac.js.map
