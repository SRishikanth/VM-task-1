...
class DocumentsDetails {
    constructor(container) {         // gets called automatically when a new object is created from the class.
        this.container = container;
         ...
         async fetchDocumentDetails() {
            try {
                ...
                const response = await fetch(`${API_BASE_URL}/verification-documents?driver_id=${driverId}`);
