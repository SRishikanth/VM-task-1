...
})({"gK7FG":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "e6d96a0fffba987f";
"use strict";
...
},{}],"7SgYN":[function(require,module,exports) {
...
class ProfileHeader {
    constructor(container){
        ...
        this.totalDistance = "";
        this.totalHours = "";
        this.totalOfficeTrips = "";
        this.totalRegularTrips = "";
        this.totalRevenue = "";
        this.driverRevenue = "";
        this.totalVehiclesDriven = "";
        this.joinedDate = "";
        this.fetchProfileData(); //the current instance of an object. It is used to access properties or methods that belong to the object in which the code is currently executing.
    }
    ...
    render() {
        this.container.innerHTML = `
            <div class="status-container">
                ...
                <div class="right">
                    <div class="status-button">
                        <span class="active-1"><img style="width: 20px; padding-right: 6px;" src="logo/path-39207@2x.png" alt="">All Documents are up to date</span>
                    </div>
                    <div class="status-button">
                        <button class="active"> ACTIVE <img style="padding-left: 4px;" src="logo/path-38334@2x.png" alt="" width="10px"></button>
                    </div>
                    <div class="icon-button">
                        <button class="pen"><img src="logo/path-38491@2x.png" width="20px"></button>
                    </div>
                    <div class="icon-button">
                        <button class="del"><img src="logo/path-38492@2x.png" width="20px"></button>
                    </div>
                </div>
            </div>
            ...
            <div class="user-info">
                <div class="img">
                    <img src="logo/vmlogo.png.jpg" alt="User Profile Picture" class="logo">
                </div>
                <div class="name-txt">
            ...
            <div class="row">
                <div class="lgo-1">
                    <img src="logo/call.png" srcset="logo/call2x.png, logo/call3x.png" class="Group-25526">
                    <img src="logo/group-25527.png" srcset="logo/group-25527@2x.png 2x, logo/group-25527@3x.png 3x" class="Group-25527">
                    <img src="logo/group-25528.png" srcset="logo/group-25528@2x.png 2x, logo/group-25528@3x.png 3x" class="Group-25528">
                    <img src="logo/group-25529.png" srcset="logo/group-25529@2x.png 2x, logo/group-25529@3x.png 3x" class="Group-25529">
                </div>
                <div class="lgo-2">
...
},{}]},["gK7FG","7SgYN"], "7SgYN", "parcelRequiref536")

//# sourceMappingURL=index.ffba987f.js.map
